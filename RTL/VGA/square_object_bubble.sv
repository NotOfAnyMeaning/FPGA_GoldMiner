...
int bottomY ;
logic insideBracket ; 
logic [6:0] OBJECT_WIDTH_X;
logic [6:0] OBJECT_HEIGHT_Y;

//////////--------------------------------------------------------------------------------------------------------------=
// Calculate object right  & bottom  boundaries
assign OBJECT_WIDTH_X = 32<<scale_factor;
assign OBJECT_HEIGHT_Y = 32<<scale_factor;
